      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
              <li><a class="page-scroll" href="addBook.php">Tambah buku</a></li>
            </ul>
          </div>
      </div>
    </div>
...
// connect database
  require_once('db_login.php');
    ...
    echo '<tr>';
          ...
          echo '<td><a class="a" href="editBook.php?id_buku='.$row->id_buku.'">Edit</a></td>';
          echo '<td><a class="a" href="deleteBook.php?id_buku='.$row->id_buku.'">Delete</a></td>';
    echo '</tr>';
    	$i++;
    }
    ...
    for ($i=1; $i<=ceil($banyakPage/$limit); $i++){
      echo "     <a class='a' href='viewBook.php?page=".$i."'>".$i."</a>";
    }
?>
  </table>
  </div>
