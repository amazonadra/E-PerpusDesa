	...
	if(!isset($_SESSION['login_anggota'])){
	    if(isset($_POST['login'])){
		  if((!empty($_POST['username']))&&(!empty($_POST['password']))){
			...
			$query=$db->query("SELECT * FROM anggota WHERE nama='$username' AND pass='$password'");

			if ($query->num_rows!=0)
			{
				$_SESSION['login_anggota']=$username;
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="card-group vamiddle">
                        <div class="card  p-a-2">
							...
							<form method="POST">
                                <h1>Masuk</h1>
                                <p class="text-muted">Masuk sebagai anggota</p>
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <input name="login" type="submit" class="btn btn-primary p-x-2" value="Masuk"></button>
																				...
																				<a href="loginAdmin.php" class="text-orange"><b>Masuk sebagain admin</b></a>
																		</div>
                                </div>
