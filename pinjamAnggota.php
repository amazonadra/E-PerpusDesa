...
<body class="bg-gray">
  <span class="navbar-default navbar-fixed-top text-muted" align="center">Masuk sebagai <?php echo $_SESSION['login_anggota']?></span>
  <nav id="mainNav" class="navbar navbar-default navbar-custom">
	...
	<?php
      ...
      $query = "SELECT * FROM anggota, peminjaman, buku, detail_transaksi WHERE anggota.id_anggota=peminjaman.id_anggota AND detail_transaksi.id_transaksi=peminjaman.id_transaksi AND detail_transaksi.id_buku=buku.id_buku AND anggota.nama='".$_SESSION['login_anggota']."' limit $start, $limit";
    ...
    for ($i=1; $i<=ceil($banyakPage/$limit); $i++){
      echo "     <a class='a' href='pinjamAnggota.php?page=".$i."'>".$i."</a>";
    }
	?>
	</table>
</div>
